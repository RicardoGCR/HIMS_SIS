...
ConsultorioExtRsEstimulacionTemprana ET01 = new ConsultorioExtRsEstimulacionTemprana();
    ...
    public void QuitarLaBarraTitulo(){ 
     ...
     public void habilitarCampos(boolean opcion){
        ...
        FUAET11.setEnabled(opcion);
        FUAET12.setEnabled(opcion);
        FUAET13.setEnabled(opcion);
        FUAET14.setEnabled(opcion);
        FUAET21.setEnabled(opcion);
        FUAET22.setEnabled(opcion);
        FUAET23.setEnabled(opcion);
        ...
        tbCiePresun = new javax.swing.JTable(){
            ...
            jPanel26Layout.setHorizontalGroup(
                ...
                .addGroup(jPanel26Layout.createSequentialGroup()
                    ...
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(lblNino, javax.swing.GroupLayout.DEFAULT_SIZE, 605, Short.MAX_VALUE)
                    .addContainerGap())
            );
