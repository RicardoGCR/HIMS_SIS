 ...
 * @author silvana
 */
public class frm_LAB_ESQUEMA_RESULTADO_INGRESO extends javax.swing.JFrame implements Runnable{
DefaultTableModel m;
...
"Tipo Esquema","cod Uni","Unidad de Medida","Valores","Resultados"};
            ...
            String u=frm_LAB_ESQUEMA_RESULTADO_INGRESO.lblUsu.getText();
 ...
 public void run() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_LAB_ESQUEMA_RESULTADO_INGRESO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_LAB_ESQUEMA_RESULTADO_INGRESO().setVisible(true);
            }
        });
    }
