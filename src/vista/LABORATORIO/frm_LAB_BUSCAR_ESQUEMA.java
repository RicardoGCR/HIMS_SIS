...
public void LAB_Analisis_Examen_cargar(){
    ...
    tb_Esquema_Analisis.getColumnModel().getColumn(5).setPreferredWidth(100);
    tb_Esquema_Analisis.getColumnModel().getColumn(6).setPreferredWidth(150);
    tb_Esquema_Analisis.getColumnModel().getColumn(7).setPreferredWidth(150);
    tb_Esquema_Analisis.getColumnModel().getColumn(8).setPreferredWidth(100);
            //Ocultar    
    ...
    tb_Esquema_Analisis.getColumnModel().getColumn(3).setMaxWidth(0);
        tb_Esquema_Analisis.getColumnModel().getColumn(9).setMinWidth(0);
    tb_Esquema_Analisis.getColumnModel().getColumn(9).setMaxWidth(0);
    tb_Esquema_Analisis.getColumnModel().getColumn(10).setMinWidth(0);
    tb_Esquema_Analisis.getColumnModel().getColumn(10).setMaxWidth(0);
        tb_Esquema_Analisis.getColumnModel().getColumn(11).setMinWidth(0);
    tb_Esquema_Analisis.getColumnModel().getColumn(11).setMaxWidth(0);
    tb_Esquema_Analisis.getColumnModel().getColumn(12).setMinWidth(0);
    tb_Esquema_Analisis.getColumnModel().getColumn(12).setMaxWidth(0);
        tb_Esquema_Analisis.getColumnModel().getColumn(13).setMinWidth(0);
    tb_Esquema_Analisis.getColumnModel().getColumn(13).setMaxWidth(0);
    tb_Esquema_Analisis.getColumnModel().getColumn(14).setMinWidth(0);
    tb_Esquema_Analisis.getColumnModel().getColumn(14).setMaxWidth(0);
    tb_Esquema_Analisis.getColumnModel().getColumn(15).setMinWidth(0);
    tb_Esquema_Analisis.getColumnModel().getColumn(15).setMaxWidth(0);
            ...
            char tecla= evt.getKeyChar();
                if(tecla==KeyEvent.VK_ENTER){
                     try{
                        ...
                        frm_LAB_ESQUEMA_RESULTADO.txtUnidadOrganica.setText(ce.LAB_Clasificacion_Examen_buscar(tb_Esquema_Analisis.getValueAt(filaselec, 4).toString()));
                        frm_LAB_ESQUEMA_RESULTADO.txtCodClasificacion.setText(tb_Esquema_Analisis.getValueAt(filaselec, 2).toString());
                        frm_LAB_ESQUEMA_RESULTADO.txtClasificacion.setText(tb_Esquema_Analisis.getValueAt(filaselec, 4).toString());
                        frm_LAB_ESQUEMA_RESULTADO.txtCodAnalisis.setText(tb_Esquema_Analisis.getValueAt(filaselec, 1).toString());
                        frm_LAB_ESQUEMA_RESULTADO.txtAnalisis.setText(tb_Esquema_Analisis.getValueAt(filaselec, 7).toString());
                        frm_LAB_ESQUEMA_RESULTADO.txtAbreviatura.setText(tb_Esquema_Analisis.getValueAt(filaselec, 8).toString());            
