 ...
 * @author PC-SISTEMA
 */
public class frm_LAB_CONTENEDOR_MUESTRA extends javax.swing.JFrame implements Runnable{
...
//        lblFecha.setText(fechaActual());
        //codigo
         LAB_Contenedor_Muestra u=new LAB_Contenedor_Muestra();
        txtCodigo.setText(u.LAB_Contenedor_Muestra_generarid());
   if(txtCodigo.getText().equalsIgnoreCase("")){
        txtCodigo.setText("CM01");
    }
...
public void calcula() {
    ...
    private void initComponents() {
        ...
        titulo5.setText("Contenedor Muestra");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jpanelLayout.createSequentialGroup()
                ...
                .addGroup(jpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jpanelLayout.createSequentialGroup()
                        ...
                        .addGap(220, 220, 220)
                        .addComponent(lblUsu, javax.swing.GroupLayout.DEFAULT_SIZE, 109, Short.MAX_VALUE))
        ...
        txtMaterial.setFont(new java.awt.Font("Segoe UI Semilight", 0, 12)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtMaterial, javax.swing.GroupLayout.PREFERRED_SIZE, 260, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel9)
                    .addComponent(txtMaterial, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        ...
        LAB_Contenedor_Muestra me=new LAB_Contenedor_Muestra();
        LAB_Contenedor_Muestra me1=new LAB_Contenedor_Muestra();
        LAB_Contenedor_Muestra me2=new LAB_Contenedor_Muestra();
        try{
          if(txtGuarModif.getText().equalsIgnoreCase("G")){
            if(txtNombre.getText().equalsIgnoreCase("")||txtMaterial.getText().equalsIgnoreCase("")){
              JOptionPane.showMessageDialog(rootPane, "Verifique si ha ingresado todos los campos");
          }  
          else if(me.LAB_Contenedor_Muestra_ver(txtNombre.getText())>0){
              ...
              if(guardar == 0 ){
                  LAB_Contenedor_Muestra meGuardar = new LAB_Contenedor_Muestra();
                  meGuardar.setCod_contenedor_exa(txtCodigo.getText());
                  meGuardar.setNombre_contenedor(txtNombre.getText());
                  meGuardar.setMaterial_contenedor(txtMaterial.getText());
                  meGuardar.setNom_usu(lblUsu.getText());
  
                  if(meGuardar.LAB_Contenedor_Muestra_guardar()){
              ...
              else if(me1.LAB_Contenedor_Muestra_codigo(txtNombre.getText()).equalsIgnoreCase(txtCodigo.getText())==false && me2.LAB_Contenedor_Muestra_ver(txtNombre.getText())>0 ){
                  JOptionPane.showMessageDialog(rootPane, "El Contenedor ingresado ya existe\nIntente nuevamente");
              txtNombre.setText("");
              txtNombre.requestFocus();
              }else{
              int modificar = JOptionPane.showConfirmDialog(this, "¿Está seguro que desea MODIFICAR los datos?",
                      "Atención", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE,i);
              if(modificar == 0 ){
                  LAB_Contenedor_Muestra ceMod= new  LAB_Contenedor_Muestra();
                  ceMod.setCod_contenedor_exa(txtCodigo.getText());
                  ceMod.setNombre_contenedor(txtNombre.getText());
                  ceMod.setMaterial_contenedor(txtMaterial.getText());
                  ceMod.setNom_usu(lblUsu.getText());
                  
                  if(ceMod.LAB_Contenedor_Muestra_modificar()){
    ...
    private void btneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarActionPerformed
        ...
        try{
            if(eliminar == 0 )
            {
                LAB_Contenedor_Muestra obj=new LAB_Contenedor_Muestra();
                obj.setCod_contenedor_exa(txtCodigo.getText());
                if(obj.LAB_Contenedor_Muestra_eliminar()){
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
       dispose();
        frm_LAB_BUSCAR_CONTENEDOR_MUESTRA lu=new frm_LAB_BUSCAR_CONTENEDOR_MUESTRA();
        lu.setVisible(true);
...
//            lblHora.setText(hora + ":" + minutos + ":" + segundos + " " + ampm);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_LAB_CONTENEDOR_MUESTRA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_LAB_CONTENEDOR_MUESTRA().setVisible(true);
            }
        });
    }
