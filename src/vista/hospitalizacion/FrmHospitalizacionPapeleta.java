 ...
 * @author PC02
 */
public class FrmHospitalizacionPapeleta extends javax.swing.JFrame {
    ...
    public FrmHospitalizacionPapeleta() {
        initComponents();
    ...
    public void limpiar(){
        ...
        int filas = tbArticulos.getRowCount();
    ...
    public boolean guardarDatosHospitalizacion(){
        ...
        if(txtBuscarNHC.getText().equals("") || cbxAreas.getSelectedIndex()== 0 || 
           cbxCama.getSelectedIndex()==0 || cbxServicio.getSelectedIndex()==0){ // validar datos vacios
        ...
        String hp_id = lblID.getText();
        String id_hc = lblIDHC.getText();
        int area = Integer.parseInt(hosp.codArea(cbxAreas.getSelectedItem().toString()));
        int cama = Integer.parseInt(hosp.codCama(lblGenero.getText(),cbxServicio.getSelectedItem().toString(),cbxCama.getSelectedItem().toString()));
        ...
        String usuario = ademer.codUsuario(lblUsuUsuario.getText());
            ...
            if(guardar == 0){
                ...
                hosp.setAr_id(area);
                hosp.setCa_id(cama);
                hosp.setHp_indicaciones(indicaciones);
                hosp.setCod_usu(usuario);
                if(hosp.mantenimientoHospitalizacionPapeleta()==true){
                    retorna = true;
                }
            }
        }
    ...
    public boolean guardarDatos(){
        ...
        if(guardarDatosHospitalizacion()==true){
            ...
            for (int i = 0; i < tbSelecArticulos.getRowCount(); i++){      
                ...
                hopsArt.setHp_id(lblID.getText());
                hopsArt.setDescripcion(tbSelecArticulos.getValueAt(i, 1).toString());
                hopsArt.setCod_usu(adEmer2.codUsuario(lblUsuUsuario.getText()));
    ...
    private void initComponents() {
        ...
        tbNHC.setSelectionBackground(new java.awt.Color(217, 100, 118));
        ...
        tbArticulos.setSelectionBackground(new java.awt.Color(217, 100, 118));
        ...
        jLabel15.setText("silvana");
        jPanel8.add(jLabel15);
        jLabel15.setBounds(420, 60, 33, 14);
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        HospitalizacionPapeletas hosp = new HospitalizacionPapeletas();
        if(hosp.idHospitalizacionPapeleta()!=null)
            lblID.setText(hosp.idHospitalizacionPapeleta());
        else
            lblID.setText("HP000000000000000001");
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        FrmHospitalizacionListarPapeleta hospL = new FrmHospitalizacionListarPapeleta();
        dispose();
    ...
    private void tbNHCKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbNHCKeyPressed
        ...
        if(teclaPresionada==KeyEvent.VK_ENTER){
            ...
            dlgNHC.dispose();
            FrmHospitalizacionPapeleta.txtBuscarNHC.setText(String.valueOf(tbNHC.getValueAt(fila, 2)));
        }
    ...
    private void cbxServicioItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbxServicioItemStateChanged
        ...
        try{  
            HospitalizacionPisos hos = new HospitalizacionPisos();
                    ...
                    ResultSet rs=sta.executeQuery("EXEC HOSPITALIZACION_CAMAS_LISTAR_LIBRES "+ servicio + ",'"+genero+"','" + "" +"'");
    ...
    private void chkAisladoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkAisladoActionPerformed
        ...
        try{  
            HospitalizacionPisos hos = new HospitalizacionPisos();
                    ...
                    ResultSet rs=sta.executeQuery("EXEC HOSPITALIZACION_CAMAS_LISTAR_LIBRES "+ servicio + ",'"+genero+"','" + tipo +"'");
                    this.cbxCama.addItem("Seleccionar...");
                    while(rs.next()){
                     this.cbxCama.addItem(rs.getString("CA_DESC"));
                  //  this.cbxProvincia.setModel(null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmHospitalizacionPapeleta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmHospitalizacionPapeleta().setVisible(true);
            }
        });
    }
