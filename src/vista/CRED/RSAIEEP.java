...
import static vista.CRED.RSAICCD.lblId;

/**
 *
 * @author MYS1
 */
public class RSAIEEP extends javax.swing.JInternalFrame {
...
JTextField fua;
JLabel cie10;
ConsultorioExtRsEpisodiosEnfermedadesPrev EEP01 = new ConsultorioExtRsEpisodiosEnfermedadesPrev();
    /**
    ...
    public void validaRegistro(int rs_id){
        try {
            PreparedStatement cmd = EEP01.getCn().prepareStatement("SELECT RS_ID FROM CONSULTORIO_EXT_RS_EPISODIOS_ENFERMEDADES_PREV WHERE RS_ID ='"+rs_id+"'");
    ...
    public void Guardar(JDateChooser fecha){
        ...
        ConsultorioExtRsEpisodiosEnfermedadesPrev CXRsEEP = new ConsultorioExtRsEpisodiosEnfermedadesPrev();
        ConsultorioExtRsEpisodiosEnfermedadesPrev CXRsEEP2 = new ConsultorioExtRsEpisodiosEnfermedadesPrev();
        try {
    
            CXRsEEP.setRsId(Integer.parseInt(lblId.getText()));
            
            if(FDN1.getDate()!=null){
                CXRsEEP.setEe1Fecha(determinarFecha(FDN1));  
                CXRsEEP.setEe1Fua(FUADN1.getText());
            }
            
            if(FDN2.getDate()!=null){
                CXRsEEP.setEe2Fecha(determinarFecha(FDN2));  
                CXRsEEP.setEe2Fua(FUADN2.getText());
            }
            if(FDN3.getDate()!=null){
                CXRsEEP.setEe3Fecha(determinarFecha(FDN3));  
                CXRsEEP.setEe3Fua(FUADN3.getText());
            }
            
            if(FDN4.getDate()!=null){
                CXRsEEP.setEe4Fecha(determinarFecha(FDN4));  
                CXRsEEP.setEe4Fua(FUADN4.getText());
            }
            
            if(FDN5.getDate()!=null){
                CXRsEEP.setEe5Fecha(determinarFecha(FDN5));  
                CXRsEEP.setEe5Fua(FUADN5.getText());
            }
            
            if(FDN7.getDate()!=null){
                CXRsEEP.setEe6Fecha(determinarFecha(FDN7));  
                CXRsEEP.setEe6Fua(FUADN7.getText());
            }
            
            
            if(FDN8.getDate()!=null){
                CXRsEEP.setEe7Fecha(determinarFecha(FDN8));  
                CXRsEEP.setEe7Fua(FUADN8.getText());
            }
            
            if(FDN9.getDate()!=null){
                CXRsEEP.setEe8Fecha(determinarFecha(FDN9));  
                CXRsEEP.setEe8Fua(FUADN9.getText());
            }
            
            if(FDN10.getDate()!=null){
                CXRsEEP.setEe9Fecha(determinarFecha(FDN10));  
                CXRsEEP.setEe9Fua(FUADN10.getText());
            }
            
            if(FDN11.getDate()!=null){
                CXRsEEP.setEe10Fecha(determinarFecha(FDN11));  
                CXRsEEP.setEe10Fua(FUADN11.getText());
            }
            
            if(CXRsEEP.mantenimientoRSAIEEP("I")==true){
                mensaje.setVisible(true);
    ...
    if(CXRsEEP.mantenimientoRSAIEEP("U")==true){
                mensaje.setVisible(true);
                mensaje.setBackground(new Color(33,115,70)); 
    ...
    private void initComponents() {
        ...
        FUADN5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                FUADN5ActionPerformed(evt);
            }
        });
        ...
        CCDM13Layout.setHorizontalGroup(
            ...
            .addGroup(CCDM13Layout.createSequentialGroup()
                .addGroup(CCDM13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, CCDM13Layout.createSequentialGroup()
                        .addGroup(CCDM13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
        ...
        jPanel144Layout.setVerticalGroup(
            jPanel144Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jLabel139, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
        );
        ...
        LEYENDA2Layout.setVerticalGroup(
            ...
            .addGroup(LEYENDA2Layout.createSequentialGroup()
                ...
                .addGap(0, 0, 0)
                .addComponent(jPanel142, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel26.setBackground(new java.awt.Color(241, 197, 14));
        ...
        jLabel10.setText("Episodios De Enfermedades Prevalentes De La Infancia");
        ...
        jPanel26Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel26Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblNino, javax.swing.GroupLayout.DEFAULT_SIZE, 393, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        DNLayout.setHorizontalGroup(
            ...
            .addComponent(jPanel26, javax.swing.GroupLayout.DEFAULT_SIZE, 1545, Short.MAX_VALUE)
        );
    ...
    private void FUADN5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FUADN5ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_FUADN5ActionPerformed
