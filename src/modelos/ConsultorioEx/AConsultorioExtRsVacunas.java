...
public class AConsultorioExtRsVacunas implements Serializable {
    ...
    public void ConsultoriosExtVacunasListar(int rs_id){
        String consulta="";
        try {
            consulta="C_EX_RS_VACUNAS_LISTAR";
...
//            cmd.setInt(1, rs_id);
            ...
            while(r.next()){
                ...
                if(r.getString(1).equals("0")){
                    ARSAIVacunas.jPanel3.setBackground(new Color(255,255,255)); 
                ...
                ARSAIVacunas.jLabel11.setText(r.getString(2));
                ARSAIVacunas.jLabel14.setText(r.getString(3));
                ARSAIVacunas.jLabel16.setText(r.getString(4));
                ARSAIVacunas.jLabel18.setText(r.getString(5));
                ARSAIVacunas.jLabel42.setText(r.getString(6));
                ARSAIVacunas.jLabel45.setText(r.getString(7));
                ARSAIVacunas.jLabel20.setText(r.getString(8));
    ...
    public AConsultorioExtRsVacunas() {
        Conexion con = new Conexion();
        cn = con.conectar();
    }

    public AConsultorioExtRsVacunas(int vacId) {
        this.vacId = vacId;
    }
