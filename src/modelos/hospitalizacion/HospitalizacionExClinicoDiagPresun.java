 ...
 * @author PC02
 */
public class HospitalizacionExClinicoDiagPresun {
    DefaultTableModel m;
    ...
    public boolean insertarDiagPresun(String tipo)
        {
        boolean resp = false;
        try{
            String sql = "HOSPITALIZACION_EXAMEN_CLINICO_DIAG_DEFI_PRESUN ?,?,?,?";
    ...
    public HospitalizacionExClinicoDiagPresun()
    {
        Conexion con = new Conexion();
        cn = con.conectar();
    }
