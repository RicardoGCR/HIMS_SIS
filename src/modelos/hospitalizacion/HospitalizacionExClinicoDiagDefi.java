 ...
 * @author PC02
 */
public class HospitalizacionExClinicoDiagDefi {
    DefaultTableModel m;
    ...
    public boolean insertarDiagDefi(String tipo)
        {
        boolean resp = false;
        try{
            String sql = "HOSPITALIZACION_EXAMEN_CLINICO_DIAG_DEFI_MANT ?,?,?,?";
    ...
    public HospitalizacionExClinicoDiagDefi()
    {
        Conexion con = new Conexion();
        cn = con.conectar();
    }
