 ...
 */
public class EC_PROGRAMACION extends javax.swing.JFrame {
byte tg;
    /**
     * Creates new form RX_EC_PROGRAMACION
     */
    public EC_PROGRAMACION() {
        initComponents();
         //ICONO DE FORMULARIO
        ...
        LIST.EC_CAJA_LISTA(dateFormat.format(date),tb_examen_det);
            ...
            if(cn.EC_CPT_verif(DIA,MES)>0){
                ...
                noeli.setVisible(false);
                        ...
                        if(rxg.EC_CAJA_NUEVO()){
                            ...
                            LIST.EC_CAJA_LISTA(FECHA,tb_examen_det);
                            txtSIS.setEditable(false);
                            txtOTROS.setEditable(false);
                            fecha_inicio.setEnabled(false);
                        }
...
//        fecha_inicio.setEnabled(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EC_PROGRAMACION.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EC_PROGRAMACION().setVisible(true);
            }
        });
    }
