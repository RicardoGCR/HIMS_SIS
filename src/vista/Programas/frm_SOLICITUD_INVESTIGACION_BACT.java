        ...
        tb_HC = new javax.swing.JTable(){
            ...
            tb_Muestra_Examen = new javax.swing.JTable(){
                ...
                tb_Nomenclatura = new javax.swing.JTable(){
                    ...
                    buscar_nomenclatura.setMinimumSize(new java.awt.Dimension(610, 414));
                    ...
                    jLabel8.setText("Médico Solicita:");
...
//                        Guardar.setCod_precio(txtCodigo.getText());
//                        Guardar.setId_hc(txtCodClasificacion.getText());
//                        Guardar.setHospServicio(txtCodNomen.getText());
//                        Guardar.setCaDesc(txtNombreExamen.getText());
//                        Guardar.setCodMuestraParaExa(txtAbrev.getText());
//                        Guardar.setAntecTratamiento(Integer.parseInt(txtTiempoHora.getText()));
//                        Guardar.setDiagnostico(Integer.parseInt(txtTiempoMin.getText()));
//                        Guardar.setControlnTratamiento(cbxTipoProc.getSelectedItem().toString());
//                        Guardar.setControlTratamiento(cbxRestric.getSelectedItem().toString());
//                        Guardar.setExNsolicBacil(cbxTipoProc.getSelectedItem().toString());
//                        Guardar.setExSolicBacil(cbxRestric.getSelectedItem().toString());
//                        Guardar.setTipoPruebaSens(cbxTipoProc.getSelectedItem().toString());
//                        Guardar.setPruebaSens(cbxRestric.getSelectedItem().toString());
//                        Guardar.setFactoresriesgoTB(cbxRestric.getSelectedItem().toString());
//                        Guardar.setExplicacion_met_proce(txtExplicacion.getText());
