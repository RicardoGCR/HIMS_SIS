...
import modelos.SALA_OPERACIONES.SDO_CONDICION;
 ...
 * @author USUARIO
 */
public class frm_SALA_OPERACION_CONDICION extends javax.swing.JFrame implements Runnable{
...
Thread h1;
    /**
     * Creates new form frm_SALA_OPERACION_CONDICION
     */
    public frm_SALA_OPERACION_CONDICION() {
        initComponents();
        c.conectar();
        ...
        //generar id 
        SDO_CONDICION a=new SDO_CONDICION();
        txtCodigo.setText(a.SDO_CONDICION_GENERAR_ID());
        if(txtCodigo.getText().equalsIgnoreCase("")){
        txtCodigo.setText("CN001");
    ...
    private void initComponents() {
        ...
        titulo5.setText("Sala de Operacion-Condicion");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtCondicion, javax.swing.GroupLayout.PREFERRED_SIZE, 260, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel7)
                    .addComponent(txtCondicion, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarActionPerformed
        ...
        try{
            if(eliminar == 0 )
            {
                SDO_CONDICION el=new SDO_CONDICION();
                el.setID_CONDICION(txtCodigo.getText());
                if(el.SDO_CONDICION_Eliminar())
                {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        //dispose();
        frm_SALA_OPERACION_CONDICION_BUSCAR tb=new frm_SALA_OPERACION_CONDICION_BUSCAR();
        tb.setVisible(true);
        frm_SALA_OPERACION_CONDICION_BUSCAR.tb_Condicion.getSelectionModel().setSelectionInterval(0, 0);
        frm_SALA_OPERACION_CONDICION_BUSCAR.tb_Condicion.requestFocus();
    ...
    public void limpiar()
    {
        SDO_CONDICION t=new SDO_CONDICION();
        txtCodigo.setText(t.SDO_CONDICION_GENERAR_ID());
        if(txtCodigo.getText().equalsIgnoreCase("")){
        txtCodigo.setText("CN001");
        }
        txtCondicion.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_SALA_OPERACION_CONDICION.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_SALA_OPERACION_CONDICION().setVisible(true);
            }
        });
    }
