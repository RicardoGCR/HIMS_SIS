 ...
 * @author MYS3
 */
public class frm_SALA_OPERACION_TIPO_ANESTESIA extends javax.swing.JFrame implements Runnable{
...
Thread h1;
    ...
    /**
     * Creates new form SALA_OPERACION_TIPO_ANESTESIA
     */
    public frm_SALA_OPERACION_TIPO_ANESTESIA() {
        initComponents();
        c.conectar();
        ...
        //generar id 
        SDO_TIPO_ANESTESIA a=new SDO_TIPO_ANESTESIA();
        txtCodigo.setText(a.SDO_TIPO_ANESTESIA_GENERAR_ID());
        if(txtCodigo.getText().equalsIgnoreCase("")){
        txtCodigo.setText("TA001");
        }
        //Fecha y Hora
        h1 = new Thread(this);
        h1.start();
    ...
    private void initComponents() {
        ...
        txtTipo_Anestesia = new javax.swing.JTextField();
        ...
        titulo5.setText("Tipo Anestesia");
        ...
        jLabel7.setText("Tipo de Anestesia:");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtTipo_Anestesia, javax.swing.GroupLayout.PREFERRED_SIZE, 260, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel7)
                    .addComponent(txtTipo_Anestesia, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        txtTipo_Anestesia.requestFocus();
    }//GEN-LAST:event_btnNuevoActionPerformed

    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        ImageIcon i=new ImageIcon(this.getClass().getResource("/imagenes/iconos/guardar16x16.png"));
        SDO_TIPO_ANESTESIA t=new SDO_TIPO_ANESTESIA();
        SDO_TIPO_ANESTESIA t1=new SDO_TIPO_ANESTESIA();
        SDO_TIPO_ANESTESIA t2=new SDO_TIPO_ANESTESIA();
        try{
            if(txtGM.getText().equalsIgnoreCase("G")){
                if(txtTipo_Anestesia.getText().equalsIgnoreCase("")){
                    JOptionPane.showMessageDialog(rootPane, "Verifique si ha ingresado todos los campos");
                }
                else if(t.SDO_Tipo_Anestesia_Ver(txtTipo_Anestesia.getText())>0){
                    JOptionPane.showMessageDialog(rootPane, "El Tipo de Anestesia ingresado ya existe\nIntente nuevamente");
                    ...
                    if(guardar == 0 ){
                        SDO_TIPO_ANESTESIA tg = new SDO_TIPO_ANESTESIA();
                        tg.setID_TIPO_ANESTESIA(txtCodigo.getText());
                        tg.setDESCRIP_TIPO_ANESTESIA(txtTipo_Anestesia.getText());
                        tg.setNOM_USU(lblUsu.getText());

                        if(tg.SDO_Tipo_Anestesia_Guardar()){
                            ...
                            JOptionPane.showMessageDialog(this, "El tipo de anestesia ya se encuentra registrado\nIntente nuevamente");
                        ...
                        if(txtTipo_Anestesia.getText().equalsIgnoreCase("")){
                        ...
                        else if(t1.SDO_Tipo_Anestesia_Codigo(txtTipo_Anestesia.getText()).equalsIgnoreCase(txtCodigo.getText())==false && t2.SDO_Tipo_Anestesia_Ver(txtTipo_Anestesia.getText())>0 ){
                            JOptionPane.showMessageDialog(rootPane, "El tipo de anestesia ingresado ya existe\nIntente nuevamente");
                            txtTipo_Anestesia.setText("");
                            txtTipo_Anestesia.requestFocus();
                        }else{
                            int modificar = JOptionPane.showConfirmDialog(this, "¿Está seguro que desea MODIFICAR los datos?",
                                "Atención", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE,i);
                            if(modificar == 0 ){
                                SDO_TIPO_ANESTESIA tm= new SDO_TIPO_ANESTESIA();
                                tm.setID_TIPO_ANESTESIA(txtCodigo.getText());
                                tm.setDESCRIP_TIPO_ANESTESIA(txtTipo_Anestesia.getText());
                                tm.setNOM_USU(lblUsu.getText());

                                if(tm.SDO_Tipo_Anestesia_Modificar()){
    ...
    private void btneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarActionPerformed
        ...
        try{
            if(eliminar == 0 )
            {
                SDO_TIPO_ANESTESIA el=new SDO_TIPO_ANESTESIA();
                el.setID_TIPO_ANESTESIA(txtCodigo.getText());
                if(el.SDO_Tipo_Anestesia_Eliminar())
                {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        //dispose();
        frm_SALA_OPERACION_TIPO_ANESTESIA_BUSCAR tb=new frm_SALA_OPERACION_TIPO_ANESTESIA_BUSCAR();
        tb.setVisible(true);
        frm_SALA_OPERACION_TIPO_ANESTESIA_BUSCAR.tb_Tipo_Anestesia.getSelectionModel().setSelectionInterval(0, 0);
        frm_SALA_OPERACION_TIPO_ANESTESIA_BUSCAR.tb_Tipo_Anestesia.requestFocus();
    ...
    {
        SDO_TIPO_ANESTESIA t=new SDO_TIPO_ANESTESIA();
        txtCodigo.setText(t.SDO_TIPO_ANESTESIA_GENERAR_ID());
        if(txtCodigo.getText().equalsIgnoreCase("")){
        txtCodigo.setText("TA001");
        }
        txtTipo_Anestesia.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_SALA_OPERACION_TIPO_ANESTESIA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_SALA_OPERACION_TIPO_ANESTESIA().setVisible(true);
            }
        });
    }
    ...
    public static javax.swing.JTextField txtTipo_Anestesia;
