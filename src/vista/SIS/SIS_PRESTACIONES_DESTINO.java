 ...
 * @author MYS3
 */
public class SIS_PRESTACIONES_DESTINO extends javax.swing.JFrame implements Runnable{
...
DefaultTableModel m, modelo1, modelo2, m3, m2;
     ...
     */
    public SIS_PRESTACIONES_DESTINO() {
        initComponents();
...
ImageIcon i=new ImageIcon(this.getClass().getResource("/imagenes/iconos/guardar16x16.png")); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SIS_PRESTACIONES_DESTINO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SIS_PRESTACIONES_DESTINO().setVisible(true);
            }
        });
    }
