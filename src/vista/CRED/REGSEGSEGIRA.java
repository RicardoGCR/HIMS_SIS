...
private Dimension DimensionBarra = null;
    ...
    public REGSEGSEGIRA() {
        ...
        seguimiento.inicializarTabla(tbSeguimientoI);
        seguimiento.listarDiagnostico(lblId.getText(), tbSeguimientoI);
    ...
    public void enviarDatosSeguimientoA(){
        int fila = tbSeguimientoI.getSelectedRow();
        txtEdad.setText(String.valueOf(tbSeguimientoI.getValueAt(fila, 2)));
        txtRes.setText(String.valueOf(tbSeguimientoI.getValueAt(fila, 3)));
        lblIdCie10.setText(String.valueOf(tbSeguimientoI.getValueAt(fila, 6)));
        txtCie10.setText(String.valueOf(tbSeguimientoI.getValueAt(fila, 4)));
        lblIdSI.setText(String.valueOf(tbSeguimientoI.getValueAt(fila, 0)));
        lblMant.setText("U");
        btnGuardar.setEnabled(true);
        habilitarDatos(true);
        String fechaSeleccionada = (String) tbSeguimientoI.getModel().getValueAt(fila, 1);
         try {
    ...
    public boolean guardarDatos(){
        ...
        try {
            ConsultorioExtRsSeguimientoIra seguimiento1 = new ConsultorioExtRsSeguimientoIra();
            AdmisionEmergenciaCabecera ad1 = new AdmisionEmergenciaCabecera();
            seguimiento1.setRs_id(Integer.parseInt(lblId.getText()));
            seguimiento1.setSiEdad(txtEdad.getText());
            ...
            if(seguimiento1.mantenimientoConsultorioExtRsSeguimientoIra(lblMant.getText())==true){
                ...
                seguimiento1.listarDiagnostico(lblId.getText(), tbSeguimientoI);
                habilitarDatos(false);
    ...
    public boolean modificarDatos(){
        ...
        try {
            ConsultorioExtRsSeguimientoIra seguimiento1 = new ConsultorioExtRsSeguimientoIra();
            seguimiento1.setSiId(Integer.parseInt(lblIdSI.getText()));
            seguimiento1.setSiEdad(txtEdad.getText());
            seguimiento1.setSiFecha(determinarFecha(dtFecha));
            seguimiento1.setSiRes(txtRes.getText());
            seguimiento1.setId_cie10(Integer.parseInt(lblIdCie10.getText()));
    ...
    private void initComponents() {
        ...
        tbCiePresun = new javax.swing.JTable(){
            ...
            tbSeguimientoI = new javax.swing.JTable(){
                public boolean isCellEditable(int rowIndex, int colIndex){
                    return false; //Disallow the editing of any cell
                }};
                ...
                lblIdSI = new javax.swing.JLabel();
                ...
                jPanel33.setPreferredSize(new java.awt.Dimension(750, 4));
                ...
                tbCiePresun.setSelectionBackground(new java.awt.Color(232, 76, 61));
                ...
                tbSeguimientoI.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
                tbSeguimientoI.setModel(new javax.swing.table.DefaultTableModel(
                    new Object [][] {
                        {null, null, null, null},
                        {null, null, null, null},
                        {null, null, null, null},
                ...
                tbSeguimientoI.setGridColor(new java.awt.Color(255, 255, 255));
                tbSeguimientoI.setRowHeight(25);
                tbSeguimientoI.setSelectionBackground(new java.awt.Color(232, 76, 61));
                tbSeguimientoI.setShowVerticalLines(false);
                tbSeguimientoI.getTableHeader().setReorderingAllowed(false);
                tbSeguimientoI.addMouseListener(new java.awt.event.MouseAdapter() {
                    public void mouseClicked(java.awt.event.MouseEvent evt) {
                        tbSeguimientoIMouseClicked(evt);
                    }
                    public void mousePressed(java.awt.event.MouseEvent evt) {
                        tbSeguimientoIMousePressed(evt);
                    }
                });
                tbSeguimientoI.addKeyListener(new java.awt.event.KeyAdapter() {
                    public void keyPressed(java.awt.event.KeyEvent evt) {
                        tbSeguimientoIKeyPressed(evt);
                    }
                    public void keyReleased(java.awt.event.KeyEvent evt) {
                        tbSeguimientoIKeyReleased(evt);
                    }
                });
                jScrollPane5.setViewportView(tbSeguimientoI);
                ...
                lblIdCie10.setForeground(new java.awt.Color(255, 255, 255));
                lblIdCie10.setText("jLabel1");

                lblIdSI.setForeground(new java.awt.Color(255, 255, 255));
                lblIdSI.setText("jLabel1");
    ...
    private void tbSeguimientoIMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbSeguimientoIMouseClicked
        if(evt.getClickCount()==1){
            enviarDatosSeguimientoA();
            lblMant.setText("U");
        }
    }//GEN-LAST:event_tbSeguimientoIMouseClicked

    private void tbSeguimientoIMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbSeguimientoIMousePressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tbSeguimientoIMousePressed

    private void tbSeguimientoIKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbSeguimientoIKeyPressed
    ...
    }//GEN-LAST:event_tbSeguimientoIKeyPressed

    private void tbSeguimientoIKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbSeguimientoIKeyReleased
        if(evt.getExtendedKeyCode()==KeyEvent.VK_DOWN || evt.getExtendedKeyCode()==KeyEvent.VK_UP){
            enviarDatosSeguimientoA();
            lblMant.setText("U");
        }
    }//GEN-LAST:event_tbSeguimientoIKeyReleased
    ...
    public static javax.swing.JLabel lblIdSI;
    ...
    public static javax.swing.JTable tbSeguimientoI;
