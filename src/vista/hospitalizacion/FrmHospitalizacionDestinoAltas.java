 ...
 * @author PC02
 */
public class FrmHospitalizacionDestinoAltas extends javax.swing.JFrame {

    /**
     * Creates new form FrmHospitalizacionDestinoAltas
     */
    public FrmHospitalizacionDestinoAltas() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        titulo5.setText("Destino de Altas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmHospitalizacionDestinoAltas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmHospitalizacionDestinoAltas().setVisible(true);
            }
        });
    }
