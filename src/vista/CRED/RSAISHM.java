...
ConsultorioExtRsSuplementacionHierro SHM01 = new ConsultorioExtRsSuplementacionHierro();
    ...
    if(fecha.getDate()==null){
        ...
        try {
            ...
            if(CXRsSHM.mantenimientoRSAISHM("U")==true){
                ...
                CXRsSHM2.porcentajeSHM(Integer.parseInt(lblId.getText()));
                habilitarDatos(false);
                habilitarRadio(true);
            }else {
                mensaje.setVisible(true);
    ...
    private void initComponents() {
        ...
        jPanel26.setBackground(new java.awt.Color(141, 68, 173));
        ...
        jLabel10.setText("Suplantación De Hierro Y/O Micronutrientes");

        jPanel27.setBackground(new java.awt.Color(154, 89, 181));
        ...
        jPanel26Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel26Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblNino, javax.swing.GroupLayout.DEFAULT_SIZE, 484, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        DNLayout.setHorizontalGroup(
            ...
            .addComponent(jPanel26, javax.swing.GroupLayout.DEFAULT_SIZE, 1531, Short.MAX_VALUE)
        );
